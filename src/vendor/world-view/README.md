# World View renderer provenance
...
file for the full license. World View's room catalog and placement logic remain
authoritative here. The site-specific adapter only presents reviewed residents
to the renderer.
